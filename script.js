...
document.querySelector('.subject.life>article')
...
document.getElementById('mark-twain-second')
...
document.querySelector('.subject').createClass = 'simplicity'

// BONUS
// TODO: [11] Create an element with the text of your favorite quote.
document.querySelector('footer').createElement(h3).innerText =
